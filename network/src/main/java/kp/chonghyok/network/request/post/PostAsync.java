package kp.chonghyok.network.request.post;
...
import kp.chonghyok.network.callback.ArrayCallback;
import kp.chonghyok.network.callback.ObjCallback;
import okhttp3.Call;
...
import static kp.chonghyok.network.request.Constant.JSON;
